package com.myapps.store.ecommerce.security;
...
public class JwtHelper {
    ...
    private final String secret = "abasdjashbdhasbdikbsfibewdkjsadbaksbdadjewifqeasdponghuitytarqwezsfhcbnGhfIdafjrRpLmbCxZlaornvfTmkhieLmOp";
    ...
    public String getUsernameFromToken(HttpHeaders headers) {
